...
class StartWorkoutView: UIView {
    ...
    private let squatsLabel = UILabel(text: "Squats", font: .robotoBold24(), textColor: .specialGray)
    private let setsLabel = UILabel(text: "Sets", font: .robotoMedium18(), textColor: .specialGray)
    private let timeOfSetLabel = UILabel(text: "Time of sets", font: .robotoMedium18(), textColor: .specialGray)
    ...
    private func setupViews() {
        ...
        [squatsLabel, setsLabel, numberOfSetsLabel, lineView,
         timeOfSetLabel, timeLabel, lineView2,
...
extension StartWorkoutView {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            timeLabel.centerYAnchor.constraint(equalTo: timeOfSetLabel.centerYAnchor),
